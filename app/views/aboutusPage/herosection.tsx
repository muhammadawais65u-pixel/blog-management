...
import herosection4 from "../../../public/assets/herosection3.png";
      ...
      <div className="relative container justify-between  gap-4 md:gap-0 py-5 md:py-0  flex-col md:flex-row flex items-center mx-auto px-6 z-10">
        <div className="w-auto md:w-[50%]">
          ...
          <p className="text-gray-200 mb-8 text-[16px]">
            ...
            deleniti in. Suscipit, sit quam perferendis dignissimos obcaecati
            magnam, vero at velit dolores, quaerat quibusdam dolorum officiis
            exercitationem aliquam quas nostrum.
          </p>
          <Button
            type="primary"
